...
select custid from sale15 where saledate >= '2015-10-01'::date and not exists (select custid from sale16 where saledate < '2016-04-01'::date);

/*check - not exsists not working correctly
