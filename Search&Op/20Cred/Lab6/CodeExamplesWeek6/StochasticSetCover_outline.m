...
while sum(I)<m     
    ...
    i = uncovered_rows_idx() % Fill in your code in the brackets; 
    % alpha_i is the indices of columns that cover row i
    alpha_i = find(); % Fill in your code in the brackets; Hint: use matrix_a
    %  select column j \in \alpha_i which covers row i with minimum cost
    [mincost, idx] = []; % Replace the square brackets with your code. Hint: use alpha_i and costs
