...
%% Read in data
[matrix_a, column_cost] = ReadInData(file);
...
[cost, population, violation] = RandomInitilisation(matrix_a, column_cost, PopSize); %%%%%%%%%%%%%%
fitness = [];

%% Evaluate phenotypes

fitness = cal_fitness(population, matrix_a, column_cost);   %Changed to population
...
while termination_flag == false
    ...
    [population, fitness] = StochasticRanking(population, fitness, violation); %Stochastic ranking
    %%%%need to update violations
    ...
    [fitness, total_cost, violation] = cal_fitness(population, matrix_a, column_cost);
